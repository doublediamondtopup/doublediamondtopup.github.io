              ...
              <table class="table table-center table-padding mb-0">
                <tbody>
                  <tr>
                    ...
                    <td class="text-end fw-bold border-0">12000</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td class="text-end fw-bold"><font color="">24000</font></td>
                  </tr>

                  <tr>
                    <td class="h6">Price</td>
                    <td class="text-end fw-bold">₹3200</td>
                  </tr>
                  <tr class="bg-light">
                    <td class="h5 fw-bold">Sub Total</td>
                    <td class="text-end text-primary h4 fw-bold">₹ 3200</td>
                  </tr>
                </tbody>
              </table>
              <form method="post" action="diamond-checkout.php">
                <input type="hidden" name="amt" value="3200">
                <div class="mt-4 pt-2">
