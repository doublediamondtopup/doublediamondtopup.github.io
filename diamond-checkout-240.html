                ...
                <table class="table table-center table-padding mb-0">
                  <tbody>
                    <tr>
                      ...
                      <td class="text-end fw-bold border-0">510</td>
                    </tr>
                    <tr>
                      <td class="h6">Bonus</td>
                      <td class="text-end fw-bold">+510</td>
                    </tr>
                    <tr>
                      <td class="h6">Total Diamonds</td>
                      <td class="text-end fw-bold"><font color="">1020</font></td>
                    </tr>
                    
                    <tr>
                      <td class="h6">Price</td>
                      <td class="text-end fw-bold">₹ 240</td>
                    </tr>
                    <tr class="bg-light">
                      <td class="h5 fw-bold">Sub Total</td>
                      <td class="text-end text-primary h4 fw-bold">₹ 240</td>
                    </tr>
                  </tbody>
                </table>
                <form method="post" action="diamond-checkout.php">
                  <input type="hidden" name="amt" value="240">
                  <div class="mt-4 pt-2">
