          ...
          <div class="col-sm-4">
            <div class="rounded shadow-lg p-4">
              <div class="d-flex mb-4 justify-content-between">
               <img src="img/diamondmax.png" class="me-3" height="50" alt="">    <h5>1 Items</h5>
             </div>
              ...
              <table class="table table-center table-padding mb-0">
                <tbody>
                  <tr>
                    ...
                    <td class="text-end fw-bold border-0">5600</td>
                  </tr>
                  <tr>
                    <td class="h6">Bonus</td>
                    <td class="text-end fw-bold">+5600</td>
                  </tr>
                  <tr>
                    <td class="h6">Total Diamonds</td>
                    <td class="text-end fw-bold"><font color="">11200</font></td>
                  </tr>
                  
                  <tr>
                    <td class="h6">Price</td>
                    <td class="text-end fw-bold">₹1600</td>
                  </tr>
                  <tr class="bg-light">
                    <td class="h5 fw-bold">Sub Total</td>
                    <td class="text-end text-primary h4 fw-bold">₹ 1600</td>
                  </tr>
                </tbody>
              </table>
              <form method="post" action="diamond-checkout.php">
                <input type="hidden" name="amt" value="1600">
                <div class="mt-4 pt-2">
