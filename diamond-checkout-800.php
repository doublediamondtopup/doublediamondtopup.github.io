              ...
              <table class="table table-center table-padding mb-0">
                <tbody>
                  <tr>
                    ...
                    <td class="text-end fw-bold border-0">2180</td>
                  </tr>
                  <tr>
                    <td class="h6">Bonus</td>
                    <td class="text-end fw-bold">+2180</td>
                  </tr>
                  <tr>
                    <td class="h6">Total Diamond</td>
                    <td class="text-end fw-bold"><font color="">4360</font></td>
                  </tr>
                  ...
                  <tr class="bg-light">
                    ...
                    <td class="text-end text-primary h4 fw-bold">₹ 800</td>
                  </tr>
                </tbody>
              </table>
              <form method="post" action="diamond-checkout.php">
                <input type="hidden" name="amt" value="800">
                <div class="mt-4 pt-2">
