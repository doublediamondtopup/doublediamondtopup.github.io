                ...
                <table class="table table-center table-padding mb-0">
                  <tbody>
                    <tr>
                      ...
                      <td class="text-end fw-bold border-0">1060</td>
                    </tr>
                    <tr>
                      <td class="h6">Bonus</td>
                      <td class="text-end fw-bold">+1060</td>
                    </tr>
                    <tr>
                      <td class="h6">Total Diamonds</td>
                      <td class="text-end fw-bold"><font color="">2120</font></td>
                    </tr>
                    ...
                    <tr class="bg-light">
                      ...
                      <td class="text-end text-primary h4 fw-bold">₹ 400</td>
                    </tr>
                  </tbody>
                </table>
          ...
          <div class="row align-items-center">
            <div class="col-sm-6">
              <div class="text-sm-start">
                ...
                </script> Gameskharido - Design by <a href="#" target="_blank" class="text-reset"></a>.</p>
              </div>
            </div>
            <!--end col-->
